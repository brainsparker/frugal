...
That installs Frugal as an MCP server in any agent client present on this machine — Claude Desktop, Cursor, AnythingLLM, or Claude Code — and wires it idempotently.
